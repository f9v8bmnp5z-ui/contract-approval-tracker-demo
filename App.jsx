...
/* ----------------------------------------------------------------------- */
/* Storage polyfill (for standalone deployment outside Claude.ai)          */
/* ----------------------------------------------------------------------- */
/* This app was originally built as a Claude artifact, which provides a    */
/* window.storage API automatically. Outside that environment, this       */
/* polyfill backs the same calls with the browser's localStorage.         */
